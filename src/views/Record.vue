<template>
  <div>
    ...
    <Loader v-if="loading" />
    <p class="center" v-else-if="!categories.length">Категорий пока нет. <router-link to="/categories">Добвить новую категорию</router-link></p>
